...
local picketbox = {
	type = "fixed",
	fixed = {
		{-0.4375, 0.125, 0.8125, 0.4375, 0.375, 0.875},
		{-0.4375, 0.0625, 0.5, 0.4375, 0.125, 0.875},
		{-0.4375, 0.125, 0.5, 0.4375, 0.375, 0.5625},
		{0.4375, 0.0625, 0.5, 0.5, 0.375, 0.875},
		{-0.5, 0.0625, 0.5, -0.4375, 0.375, 0.875},
	}
}
...
local picketbox_full = {
	...
	fixed = {
		...
		{0.4375, 0.0625, 0.5, 0.5, 0.375, 0.875},
		{-0.5, 0.0625, 0.5, -0.4375, 0.375, 0.875},
		{-0.4375, 0.0625, 0.5625, 0.4375, 0.3125, 0.8125}, -- Dirt Inside Flowerbox
	}
}
...
local picketbox_flowers = {
	type = "fixed",
	fixed = {
		{-0.5, -0.625, 0.5, 0.5, -0.5, 0.875},
		{-0.5, -0.6875, 0.4375, 0.5, -0.5, 0.5},
		{-0.375, -0.75, 0.4375, 0.375, -0.6875, 0.5},
		{-0.1875, -0.8125, 0.4375, 0.1875, -0.75, 0.5},
		{0.5, -0.5625, 0.4375, 0.5625, -0.5, 0.875},
		{0.5, -0.625, 0.4375, 0.5625, -0.5625, 0.8125},
		{0.5, -0.6875, 0.4375, 0.5625, -0.625, 0.6875},
		{-0.5625, -0.5625, 0.4375, -0.5, -0.5, 0.875},
		{-0.5625, -0.625, 0.4375, -0.5, -0.5625, 0.8125},
		{-0.5625, -0.6875, 0.4375, -0.5, -0.625, 0.6875},
	}
}

local selection_box = {
	type = "fixed",
	fixed = {{-0.5, 0.0625, 0.5, 0.5, 0.375, 0.875}}
}
...
function flowerbox.register_box_variant(subname, groups, mat_tex, type_desc, node_type, empty_boxes, full_boxes, flower_boxes, selection_boxes, sounds)
	...
	minetest.register_node(":" .. full_name, {
		...
		tiles = {"default_dirt.png", mat_tex},
		paramtype = "light",
		paramtype2 = "facedir",
		groups = hidden_groups,
		sounds = sounds,
